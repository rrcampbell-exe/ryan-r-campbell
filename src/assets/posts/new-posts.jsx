      ...
      rendered:
        `<div>
          ...
          <div>
            ...
            <h3><em>I'd become so caught up in the idea of a singular identity, and that was... not great.</em></h3>
          </div>
        </div>
          <div>
          ...
          <div class='Text-And-Image-Container image-on-left'>
            <div class='text-block'>
            ...
            <div class='image-block'>
              <img src='/favicon-2024-ryan-r-campbell.png' />
              <div class='caption-container'>
                <span>Surprises incoming? Time will tell...</span>
              </div>
            </div>
          </div>
        </div>`,
