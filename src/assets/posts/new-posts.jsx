        ...
        `<div>
          <div class='Text-And-Image-Container'>
            ...
            <div class='image-block'>
              <img src='/books/scambait/scambait-flat-cover-international-book-awards-readers-favorite-sticker.png' />
              <div class='caption-container'>
                <span>The 2022 International Book Awards finalist in Humor & Satire</span>
              </div>
            </div>
          </div>
          <div>
            ...
            <div class='Quote'>
              <div>
                <svg class='quotes-svg' viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <g>
                    <path fill="none" d="M0 0h24v24H0z"/>
                    <path d="M4.583 17.321C3.553 16.227 3 15 3 13.011c0-3.5 2.457-6.637 6.03-8.188l.893 1.378c-3.335 1.804-3.987 4.145-4.247 5.621.537-.278 1.24-.375 1.929-.311 1.804.167 3.226 1.648 3.226 3.489a3.5 3.5 0 0 1-3.5 3.5c-1.073 0-2.099-.49-2.748-1.179zm10 0C13.553 16.227 13 15 13 13.011c0-3.5 2.457-6.637 6.03-8.188l.893 1.378c-3.335 1.804-3.987 4.145-4.247 5.621.537-.278 1.24-.375 1.929-.311 1.804.167 3.226 1.648 3.226 3.489a3.5 3.5 0 0 1-3.5 3.5c-1.073 0-2.099-.49-2.748-1.179z"/>
                  </g>
                </svg>
                <h3><em>... writing fell to the wayside. Like way-way-way to the wayside.</em></h3>
              </div>
            </div>
            ...
            <p>In fact, I'd say the break was a necessary one, and one that has me ready, again, to get back into the groove. A <em>new</em> groove (please don't throw it off).</p>
          </div>
          <div>
            <h2>New Business</h2>
