...
const MissPrimmcomHostsMourningDove = () =>
  <div>
    <p>Last week, Angelica Primm hosted me for an author interview as part of&nbsp;<em>Mourning Dove</em>‘s launch week. So what did I have to say about the the EMPATHY saga's themes and misconceptions some have had about book one,&nbsp;<em>Imminent Dawn</em>?</p>
<p><a href="http://missprimm.com/author-interview-r-r-campell-and-mourning-dove/#more-312" target="_blank" rel="noopener noreferrer">You'll have to read this interview to find out.</a></p>
<p>Still need to get a copy of either of the first two books in the series? You can find them below.</p>
...
export default MissPrimmcomHostsMourningDove
