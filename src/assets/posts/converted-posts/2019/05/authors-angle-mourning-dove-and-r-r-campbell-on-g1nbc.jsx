...
const AuthorsAngleMourningDoveandRRCampbellonG1NBC = () =>
  <div>
    <p>G1NBC of Livingston County, Michigan recently featured me and the EMPATHY series in <a href="http://g1nbc.com/howell-mi/2019/05/03/authors-angle-mourning-dove-by-r-r-campbell/?fbclid=IwAR0D4kPn_bqjEgIqduco1dn3_ECoQfhUVj_2ZbWrrlbd4XHNVOGfYTt7_oc" target="_blank" rel="noopener noreferrer">this interview on their site!</a></p>
<p>Over the course of our conversation, I dive into the challenges I faced while writing <em>Mourning Dove</em>, and what led me to writing in the first place.</p>
<p>You can learn all about <em>Mourning Dove </em>and book one in the EMPATHY sci-fi saga, <em>Imminent Dawn</em>, at the link above! And if you haven't yet purchased your copies of the first two installments in the series, you can find them below.</p>
...
export default AuthorsAngleMourningDoveandRRCampbellonG1NBC
