...
const MourningDovefeaturedonVelvetPanic = () =>
  <div>
    <p>Velvet Panic recently hosted <em>Mourning Dove </em>to commemorate the kick off of book two in the EMPATHY sci-fi saga. Thanks to Velvet Panic for hosting <a href="https://velvetpanic2.wordpress.com/2019/05/01/release-blitz-mourning-dove-by-rr-campbell/" target="_blank" rel="noopener noreferrer">this post</a>!</p>
<p>If you still need to get your hands on either of the first two installments in the EMPATHY series, you can find them below.</p>
...
export default MourningDovefeaturedonVelvetPanic
