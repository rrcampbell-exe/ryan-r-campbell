...
const boasts = [
  ...
  },
  {
    ...
    description: [
      'Only Software Engineer III selected to be a mentor in Northwestern Mutual\'s engineering mentorship program',
      'Chaired the Core Enablers mentorship committee, expanding program\'s reach across engineering, product, and design',
