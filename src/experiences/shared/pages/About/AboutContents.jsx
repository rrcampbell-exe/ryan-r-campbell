...
export const ShortStory = ({ setIsShortStory }) =>
  <>
    ...
    <div>
      ...
      <p>In an adult life of transitions from from pizza-slinging pyscholinguist to international sales support to international book awards finalist, it'd be easy to view the bounce-about nature of my path as that of a wanderer.</p>
      <p>And, with a career spanning industries including agriculture, medical devices, international regulatory affairs, and publishing, I'd be hard pressed to tell you you're wrong. But, if there's anything I've learned in my travels—both physical and professional—it's that to wander is wonderful, but to wander with a sense of wonder is, if you'll pardon the excessive alliteration, <em>wondrous</em>.</p>
      <p>It's in following that sense of wonder that I've been most comfortable over the years. Whether while interviewing dozens (a hundred? more?) authors and publishing professionals as part of <Link to='/podcasts'>the Writescast Network</Link>, immersing myself in the <Link to='/author'>writing of another manuscript</Link>, or untangling <Link to='/tech'>twisted tangles of code</Link>, curiosity and wonder have served me well as binary north stars.</p>
      <p>So, go on: cultivate your curiosity. Walk with that sense of wonder. Do some exploring of your own and learn all there is to learn.</p>
      <p>And, if you're really up for it, consider reading <span className='story-toggle-span' onClick={() => setIsShortStory(false)}>the extended version of the story so far</span>. I think you might like what you find.</p>
    </div>
  </>
...
export const LongStory = () =>
  <>
    ...
    <div>
      ...
      <p>Go figure.</p>
      <p>Ultimately, it's taken me a long time to understand—and to embrace—who I am, and the only way to understand that for yourself is to see the story in sum, or at least the story as I see it, anyway.</p>
    </div>
    <div>
      <h3>big plans</h3>
    ...
    <div>
      ...
      <p>I should mention that only one of these options also came with diesel-strength espresso.</p>
      <p>Viewed through that lens, my choice was more or less made for me. Brazil it was!</p>
      <p>In a surprise to absolutely no one, three months of largely unstructured time—complemented by copious amounts of aforementioned espresso—led to interesting outcomes, the most notable of which was that <b>I finally got around to writing that novel I'd been talking about for years</b>.</p>
    </div>
    <div>
      <h3>the great american novel (as written in brazil)</h3>
      ...
      <p>That the novel in question does not figure among <Link to='/books'>my published works</Link> should tell you precisely how hard it in fact is.</p>
      <p>Naivete aside, over the course of those three months, I did write something vaguely resembling a manuscript, a dream I'd had since I was in elementary school. I thought for sure that once I returned to the U.S., I'd not land my first Real Job™, but I'd also apply to grad school and, naturally, get a novel published on the side.</p>
      <p>This is not at all what transpired.</p>
    </div>
    <div>
      <h3>best laid plans</h3>
      <p>Life comes at you fast, as they say, and I'm not sure life has ever come at me much quicker than in my first few months back stateside.</p>
      <p>After a fruitless series of interviews in the quest for the fabled Real Job™, I relented and returned to my pizza delivery gig. In between late night pizza delivery shifts, I wrote. Like, <em>all the time</em>. I even carried a back-pocket-sized notepad with me to write on when it wasn't practical to bust out my laptop.</p>
      <p>I also sought community. Through the University of Wisconsin-Madison's Continuing Studies in Writing program, I enrolled in courses, connected with a critique group, and dedicated myself to attending it religiously every other Saturday morning for years. It turned out I had far more to learn than I ever could have imagined, but I remained determined to see my work through to publication.</p>
      <p>However, after two years of dedicated practice and study (and countless attempts to attract a literary agent to represent me and my work), I felt no closer to seeing my words in print, and the late-night pizza gig was finally taking its toll. Oh, and that psycholinguistics program at MIT... whatever happened to that?</p>
      <p>Clearly on the verge of a quarter-life crisis, I did what any reasonable person in my position would do: I quit my job and went to Brazil. <em>Vambora!</em></p>
    </div>
    <div>
      <h3>trade-offs and trade-ups</h3>
      ...
      <p>Then, on a late summer day in 2014, fate intervened, by which I mean the HR department of an agricultural firm. To support their sales in Latin America, they were in desperate need of someone who spoke Spanish and Portuguese, which, wouldn't you know it, was something I was more than capable of taking on.</p>
    ...
    <div>
      <h3>everything was fine (except it wasn't)</h3>
      ...
      <p>In the same way that the pizza delivery gig's late night hours eventually chased me from the service industry, the round-the-clock maintenance of my work as an author, podcaster, writing coach, and business owner had ground my soul into dust, and that's without mention of the gut-wrenching truth—one I'd been ignoring for years—that I had made much more money as a pizza delivery driver than I was ever going to make as an author.</p>
    ...
    <div>
      ...
      <p>This transition was not without bumps along the way, and plenty of secondary consequences accompanied the move. After seven years playing on the same soccer team, I had to bid the Men of the Night's Watch adieu and look for a team in the Milwaukee area with which I could ply that particular trade. We had to sweat it out while we waited for the sale of our Madison-area condo to close. My wife had to adjust to the now fully-remote version of her own job.</p>
    ...
    <div>
      <h3>stability, or something like it</h3>
